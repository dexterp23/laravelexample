...
@section('content')
	...
	<div class="header">
        <h1 class="header-title">
            @if(!empty($data[0]->name)){{ $data[0]->name }}@else{{ 'Vendor' }}@endif
        </h1>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('vendors.update') }}" method="post" name="form" id="form" class="">
                    	@method('POST')
                        @csrf
                        ...
                        <div class="form-actions">
							...
							@if(!empty($data[0]))
                                <a href="{{ route('vendors.add') }}" class="btn btn-success float-right ml-1">Add New</a>
                                ...
                                <script>
                                    function rusure(){
                                        ...
                                        if (question !="0"){
                                            top.location = "{{ route('vendors.delete', $data[0]->id) }}"
                                        }
                                    }
                                </script>
                            @endif
