...
@section('content')
	...
	<div class="header">
        <h1 class="header-title">
            @if(!empty($data[0]->name)){{ $data[0]->name }}@else{{ 'Page' }}@endif
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fas fa-fw fa-home"></i></a></li>
                <li class="breadcrumb-item"><a href="{{ route('pages.list') }}">Holding Pages</a></li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
					...
					<form action="{{ route('pages.update') }}" method="post" name="form" id="form" class="">
                    	@method('POST')
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2 text-sm-right">URL <span class="required_asterix">*</span></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-actions">
							...
							@if(!empty($data[0]))
                                <a href="{{ route('pages.add') }}" class="btn btn-success float-right ml-1">Add New</a>
                                ...
                                <script>
                                    function rusure(){
                                        ...
                                        if (question !="0"){
                                            top.location = "{{ route('pages.delete', $data[0]->id) }}"
                                        }
                                    }
                                </script>
                            @endif
